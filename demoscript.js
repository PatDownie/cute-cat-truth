...
function favCatQuestion() {
  ...
  while(personalGreeting === ""){
    let favCat = prompt(user + ", what is your favourite classic cat colour? Black or orange?");
    if (favCat === "none" || favCat === "neither" || favCat === "None" || favCat === "Neither") {
      personalGreeting = "Good answer " + user;
    }
    else if (favCat === "Black" || favCat === "black" || favCat === "Orange" || favCat === "orange") {
      personalGreeting = "I must warn you, " + user + ", " + favCat + " cats are evil!";
    }
    else {
...
function rating() {
  ...
  for (let i = 0; i < rating; i++) {
    output += "<img class='angrycat' src='images/angry-cat.png' alt='angry cat'>";
  }
...
function minecraft() {
  ...
  console.log(buttonCounter);
    ...
    document.getElementById("minecraft-button").innerHTML = "You broke the button by clicking it too much, these HTML elements don't last forever you know";
  }
}